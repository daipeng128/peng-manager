...
import com.peng.listener.SimpleConsumerListener;
...
public class KafkaConfig {
    ...
    public KafkaAdmin admin() {
        ...
        configs.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG,"152.136.82.220:9092");
...
//topic的配置结束
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "152.136.82.220:9092");
        props.put("acks", "all");
        props.put("retries", 0);
